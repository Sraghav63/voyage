...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color russianViolet = const Color(0xFF10002B);
  late Color russianViolet2 = const Color(0xFF240046);
  late Color persianIndigo = const Color(0xFF3C096C);
  late Color tekhelet = const Color(0xFF5A189A);
  late Color frenchViolet = const Color(0xFF7B2CBF);
  late Color amethyst = const Color(0xFF9D4EDD);
  late Color heliotrope = const Color(0xFFC77DFF);
  late Color mauve = const Color(0xFFE0AAFF);
}
