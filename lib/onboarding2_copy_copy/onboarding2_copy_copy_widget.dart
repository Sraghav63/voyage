...
import 'onboarding2_copy_copy_model.dart';
...
class Onboarding2CopyCopyWidget extends StatefulWidget {
  ...
  State<Onboarding2CopyCopyWidget> createState() =>
      _Onboarding2CopyCopyWidgetState();
}

class _Onboarding2CopyCopyWidgetState extends State<Onboarding2CopyCopyWidget>
    with TickerProviderStateMixin {
  late Onboarding2CopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Onboarding2CopyCopyModel());
