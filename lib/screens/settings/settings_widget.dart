  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UserinfoRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserinfoRow> settingsUserinfoRowList = snapshot.data!;

        final settingsUserinfoRow = settingsUserinfoRowList.isNotEmpty
            ? settingsUserinfoRowList.first
            : null;
                                  ...
                                  children: [
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          valueOrDefault<String>(
                                            settingsUserinfoRow?.displayname,
                                            'user-name',
                                          ),
                                          textAlign: TextAlign.start,
                                          style: FlutterFlowTheme.of(context)
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          valueOrDefault<String>(
                                            settingsUserinfoRow?.age.toString(),
                                            'age',
                                          ),
                                          textAlign: TextAlign.start,
                                          style: FlutterFlowTheme.of(context)
