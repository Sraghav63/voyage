  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UserinfoRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserinfoRow> details38TransactionHistoryResponsiveUserinfoRowList =
            snapshot.data!;

        final details38TransactionHistoryResponsiveUserinfoRow =
            details38TransactionHistoryResponsiveUserinfoRowList.isNotEmpty
                ? details38TransactionHistoryResponsiveUserinfoRowList.first
                : null;
